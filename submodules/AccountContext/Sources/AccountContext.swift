...
public struct AyuGramInputControls: Equatable {
    ...
    public init(
        showAttachButtonInMessageField: Bool,
        showCommandsButtonInMessageField: Bool,
        showEmojiButtonInMessageField: Bool,
        showMicrophoneButtonInMessageField: Bool,
        showAutoDeleteButtonInMessageField: Bool,
        showGiftButtonInMessageField: Bool,
        showAiEditorButtonInMessageField: Bool,
    ...
    public static var `default`: AyuGramInputControls {
        return AyuGramInputControls(
            ...
            showGiftButtonInMessageField: true,
            showAiEditorButtonInMessageField: true,
...
public struct AyuGramDrawerControls: Equatable {
    ...
    public init(
        ...
        showNewGroupInDrawer: Bool,
        showNewChannelInDrawer: Bool,
        showContactsInDrawer: Bool,
        showCallsInDrawer: Bool,
        showSavedMessagesInDrawer: Bool,
        showLReadToggleInDrawer: Bool,
        showSReadToggleInDrawer: Bool,
        showNightModeToggleInDrawer: Bool,
        showGhostToggleInDrawer: Bool,
        showStreamerToggleInDrawer: Bool,
        showGhostToggleInTray: Bool,
        showStreamerToggleInTray: Bool
    ) {
    ...
    public static var `default`: AyuGramDrawerControls {
        return AyuGramDrawerControls(
